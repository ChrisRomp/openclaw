...
// Validated against the Copilot enterprise API:
...
> = {
  "claude-opus-4.6": { api: "openai-completions", contextWindow: 200_000, reasoning: true },
  "claude-opus-4.5": { api: "openai-completions", contextWindow: 200_000, reasoning: true },
  "claude-sonnet-4.6": { api: "openai-completions", contextWindow: 200_000 },
  "claude-sonnet-4.5": { api: "openai-completions", contextWindow: 200_000 },
  "gpt-5.3-codex": { api: "openai-responses", contextWindow: 400_000 },
  "gpt-5.2-codex": { api: "openai-responses", contextWindow: 400_000 },
};
